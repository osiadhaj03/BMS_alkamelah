    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-2">
        ...
        <div class="group relative bg-green-50 rounded-lg p-3 cursor-pointer border border-green-200 transition-all hover:shadow-sm">
             ...
             <div class="flex justify-between items-start mb-1">
                 <h4 class="font-bold text text-gray-900 line-clamp-1 ">المجموع شرح المهذب</h4>
        ...
        <div class="group relative bg-white hover:bg-gray-50 rounded-lg p-3 cursor-pointer border border-gray-100 hover:border-gray-300 transition-all">
             <div class="flex justify-between items-start mb-1">
                 <h4 class="font-bold text text-gray-800 line-clamp-1 ">المغني</h4>
        ...
        <div class="group relative bg-white hover:bg-gray-50 rounded-lg p-3 cursor-pointer border border-gray-100 hover:border-gray-300 transition-all">
             <div class="flex justify-between items-start mb-1">
                 <h4 class="font-bold text text-gray-800 line-clamp-1 ">بداية المجتهد ونهاية الموقتصد</h4>
        ...
        <div class="group relative bg-white hover:bg-gray-50 rounded-lg p-3 cursor-pointer border border-gray-100 hover:border-gray-300 transition-all">
             <div class="flex justify-between items-start mb-1">
                 <h4 class="font-bold text text-gray-800 line-clamp-1 ">الكتب الستة</h4>
