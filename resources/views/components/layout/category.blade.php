...
<div class="relative overflow-hidden bg-[#fafafa]" id="book-sections">
    ...
    <section class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20" dir="rtl">
            ...
            @forelse ($sections as $section)
                <a href="{{ route('home', ['type' => 'books', 'section' => $section->slug]) }}" 
                   class="group bg-white rounded-[2rem] shadow-xl shadow-green-900/5 overflow-hidden border border-gray-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-green-900/10 relative">
                    ...
                    <img src="{{ asset('images/mask-group0.svg') }}" 
                         alt="" 
                    ...
                    <div class="p-8 relative z-10">
                        <div class="flex items-center gap-6">
                            <!-- Category Icon/Logo -->
                            <div class="w-20 h-20 flex-shrink-0 flex items-center justify-center bg-[#f8faf9] rounded-2xl group-hover:bg-[#e8f5e9] transition-colors p-3">
                            ...
                            <!-- Category Details -->
                            <div>
                                <h3 class="text-xl md:text-2xl font-bold text-[#1a3a2a] group-hover:text-[#2C6E4A] transition-colors mb-2">
                                    {{ $section->name }}
                                </h3>
                                <div class="flex items-center gap-2">
                                    <span class="inline-flex items-center px-4 py-2 rounded-full text-xs font-bold bg-[#e8f5e9] text-[#2e7d32]">
        ...
        <div class="flex justify-center">
            <a href="{{ route('home') }}" class="group relative px-10 py-4 bg-white border-2 border-[#2C6E4A] text-[#2C6E4A] rounded-full font-bold text-lg overflow-hidden transition-all hover:text-white">
                <div class="absolute inset-0 bg-[#2C6E4A] translate-y-full group-hover:translate-y-0 transition-transform duration-300 -z-10"></div>
