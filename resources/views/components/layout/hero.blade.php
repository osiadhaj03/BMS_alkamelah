                ...
                <div class="bg-white px-6 pt-5 pb-4 border-b border-gray-100">
                    ...
                    <div class="flex border-b border-gray-200">
                        <button @click="authorsFilterTab = 'madhhab'"
                            ...
                            :class="authorsFilterTab === 'madhhab' ? 'border-green-600 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 text-right'">
                            المذهب
                        </button>
                        <button @click="authorsFilterTab = 'century'"
                            class="flex-1 pb-3 text-sm font-bold text-center border-b-2 transition-colors duration-200"
                            :class="authorsFilterTab === 'century' ? 'border-green-600 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 text-right'">
                            القرن
                        </button>
                        <button @click="authorsFilterTab = 'daterange'"
                            class="flex-1 pb-3 text-sm font-bold text-center border-b-2 transition-colors duration-200"
                            :class="authorsFilterTab === 'daterange' ? 'border-green-600 text-green-600' : 'border-transparent text-gray-500 hover:text-gray-700 text-right'">
                            نطاق التاريخ
                        </button>
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-4 bg-gray-50 max-h-72">
                    ...
                    <div x-show="authorsFilterTab === 'daterange'">
                        <div class="bg-white rounded-lg p-5 shadow-sm">
                            <p class="text-gray-600 mb-5 text-right" style="font-size: 1rem; line-height: 1.5rem;">أدخل
                                نطاق سنة
                                الوفاة بالتقويم الهجري:</p>
                            <div class="flex gap-4 items-center flex-row-reverse">
                                <div class="flex-1">
                                    <label class="block font-medium text-gray-700 mb-2 text-right"
                                        style="font-size: 1rem;">من
                                        سنة</label>
                                    <input type="number" x-model="deathDateFrom" placeholder="مثال: 150" min="1"
                                        max="1500" class="w-full px-4 py-3 rounded-lg border border-gray-300 text-right"
                                        style="font-size: 1rem;">
                                </div>
                                <span class="text-gray-400 pt-8 text-xl">—</span>
                                <div class="flex-1">
                                    <label class="block font-medium text-gray-700 mb-2 text-right"
                                        style="font-size: 1rem;">إلى
                                        سنة</label>
