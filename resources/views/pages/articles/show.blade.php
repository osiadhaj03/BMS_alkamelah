        ...
        <section class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12" dir="rtl">
            <article class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <!-- Back Button -->
                    <div class="mt-8">
                        <a href="{{ route('articles.index') }}" class="inline-flex items-center gap-2 px-6 py-3 text-white rounded-lg font-bold transition-colors" style="background-color: #2C6E4A;" onmouseover="this.style.backgroundColor='#1A3A2A'" onmouseout="this.style.backgroundColor='#2C6E4A'">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
