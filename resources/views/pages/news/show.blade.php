...
<div class="container mx-auto px-4 py-8" dir="rtl">
    <article class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-8">
            ...
            <!-- العودة للأخبار -->
            <div class="mt-8">
                <a href="{{ route('news.index') }}" class="inline-flex items-center gap-2 px-6 py-3 text-white rounded-lg font-bold transition-colors" style="background-color: #2C6E4A; hover:background-color: #1A3A2A;">
