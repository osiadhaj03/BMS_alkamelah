...
@section('content')
    <div class="flex flex-col h-screen bg-gray-50" dir="rtl" x-data x-init="$store.search.init()">
        ...
        <div x-data="{ show: true }" x-show="show" class="bg-yellow-50 border-b border-yellow-200 p-4 relative z-50">
            <div class="flex items-center justify-center">
                ...
                <div class="mr-3 flex-1 md:flex-none text-center">
                    <p class="text-sm font-medium text-yellow-800">
                        تنبيه: معلومات بعض الكتب و بعض المؤلفين غير مكتملة، يعمل فريق المكتبة عليها حالياً.
                        <a href="{{ route('feedback', ['type' => 'complaint', 'category' => 'general', 'subject' => 'إبلاغ عن نقص بيانات']) }}" class="font-bold underline hover:text-yellow-900 mr-1">
                            يرجى الابلاغ عنها
                        </a>
                    </p>
                </div>
